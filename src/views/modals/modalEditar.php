            ...
            <div class="modal-body">
                <form id="formularioUsuarioEdit" action="" method="POST" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="id_tdoc" id="id_tdoc" class="form-select" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="id_usuario" id="id_usuario_edit" class="form-control" maxlength="10" oninput="validateLength(this)" pattern="\d{1,10}" required />
                    </div>
                    <div class="row">
                        <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="correo" id="correo" class="form-control" required pattern="[^@\s]+@[^@\s]+\.[^@\s]+">
                        <div class="invalid-feedback">Por favor, ingresa un correo electrónico válido.</div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Telefono</label>
                        <input type="text" name="telefono" id="telefono" class="form-control" maxlength="10" oninput="validateLength(this)" pattern="\d{1,10}" required />
                    </div>
                    <div class="mb-3">
